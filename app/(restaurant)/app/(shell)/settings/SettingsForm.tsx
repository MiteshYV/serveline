  ...
  return (
    <form action={act} className={styles.form}>
      ...
      <fieldset className={styles.fieldset}>
        <legend className={styles.legend}>Hours</legend>
        <p className={styles.hint}>Opening spans in IST, like <span className="num">07:00-15:30, 18:30-22:30</span>. Leave a day blank if closed.</p>
        {DAYS.map(([key, label]) => (
      ...
      <fieldset className={styles.fieldset}>
        ...
        <label className={styles.check}><input type="checkbox" name="codEnabled" defaultChecked={values.codEnabled} /> Cash on delivery</label>
      </fieldset>

      <fieldset className={styles.fieldset}>
        <legend className={styles.legend}>Phones</legend>
        ...
        <p className={styles.hint}>The handoff number is where the AI transfers a call it cannot finish (M2). The owner mobile is where the carrier sends calls if the AI does not answer.</p>
      </fieldset>
